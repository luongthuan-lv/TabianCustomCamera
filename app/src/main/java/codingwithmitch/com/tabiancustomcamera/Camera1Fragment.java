...
//            mCaptureSession.capture(mPreviewRequestBuilder.build(), captureCallbackHandler, mBackgroundHandler);
    ...
    private void resetIconVisibilities() {
        ...
        mColorPickerContainer.setEnabled(false);
        mUndoContainer.setEnabled(false);
        mPenContainer.setEnabled(false);
        mStickerContainer.setEnabled(false);
        mFlashContainer.setEnabled(false);
        mTrashContainer.setEnabled(false);
        ...
        mCaptureBtnContainer.setVisibility(View.GONE);
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            if (mImage != null) {
                ...
                try {
                    String fname = "CaptureImage" + System.currentTimeMillis() + ".jpg";
